...
namespace ArgoCD.Client.Models
{
    ...
    public partial class V1PortStatus
    {
        ...
        /// +kubebuilder:validation:MaxLength=316</param>
        ...
        /// The supported values are: "TCP", "UDP", "SCTP"</param>
        public V1PortStatus(string error = default(string), int? port = default(int?), string protocol = default(string))
        {
            Error = error;
            Port = port;
            Protocol = protocol;
